...
function HomePage() {
  ...
  async function getUserEntries() {
    let response = await fetch(
      `${BACKEND_URL_DAILY_ENTRIES}?token=${user.sub.slice(6, user.sub.length)}`
    );
        ...
        >
          ...
          <VStack display="flex" spacing="5%">
            ...
            <VStack width="85%" paddingLeft="5%">
              ...
              />
              <UnorderedList styleType="none" overflowY="scroll" height="200px" width="100%">
